(function() {
	...
	const TRAIN_DATA = {
		...
		"US-100 (WSH)": {
			"id": "US-100 (WSH)",
			"name": "US-100 (WSH)",
			"description": "Paris has trams and they are quite narrow but not as much as Berlin. The United Streetcar 100 is a articulated low-floor streetcar built via licensing the �koda 10T. It has been in service with the Paris Tram Narrow since 2016. Capacity is artificially higher due to game processing requirements.",
			"allowAtGradeRoadCrossing": false,
			"stats": {
				"maxAcceleration": 1.34,
				"maxDeceleration": 1.34,
		...
		"Cuautitl�n-Buenavista": {
			...
			"description": "The Northeast Corridor is the major high speed corridor in the United States that goes from Boston to Washington. It has 3 electrification standards, and this is the 25kV AC 60 Hz system which matches international standards. The Cuautitl�n-Buenavista is a commuter rail EMU built by CAF used on Mexico City's Tren Suburbano that entered service in 2008. ",
			"allowAtGradeRoadCrossing": false,
			"stats": {
				"maxAcceleration": 1.0,
				"maxDeceleration": 1.0,
		...
		"Alt�o (PAR)": {
			"id": "Alt�o (PAR)",
			"name": "Alt�o (PAR)",
			"description": "Transilien is the commuter rail network that serves Paris, and also includes the R�seau Express R�gional which is a hybrid between commuter and rapid. It has four standards, this is the narrow, 1500V DC version. The MI 2N Alt�o is a double-decker EMU built by Alstom as part of their X'Trapolis family that has been in service on the French RER's line A since 1997. They were refurbrished from 2019-2021.",
			"allowAtGradeRoadCrossing": false,
			"stats": {
		...
		"�ole (PAR)": {
			"id": "�ole (PAR)",
			"name": "�ole (PAR)",
			"description": "Metra is a commuter rail network found in the Chicago Metropolitan Area. The Z 22500 �ole is a commuter rail double-decker EMU built by ANF and Alstom that operates on the RER E Line. It entered service in 1996.",
			"allowAtGradeRoadCrossing": false,
			"stats": {
				"maxAcceleration": 1.0,
				"maxDeceleration": 1.15,
		...
		"I� 22000": {
			"id": "I� 22000",
			"name": "I� 22000",
			"description": " The I� Class 22000 is an Irish DMU used for both commuter rail and intercity services. It was built by Hyundai Rotem and entered service in 2007. Acceleration is guesstimated.",
			"allowAtGradeRoadCrossing": false,
			"stats": {
				"maxAcceleration": 0.7,
				"maxDeceleration": 0.7,
		...
		"I� 29000": {
			"id": "I� 29000",
			"name": "I� 29000",
			"description": " The I� Class 29000 is an Irish commuter rail DMU built by CAF that entered service in 2003. Acceleration is guesstimated.",
			"allowAtGradeRoadCrossing": false,
			"stats": {
				"maxAcceleration": 0.9,
				"maxDeceleration": 0.9,
